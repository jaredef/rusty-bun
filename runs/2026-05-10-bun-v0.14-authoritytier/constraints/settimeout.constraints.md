...
Surface drawn from 2 candidate properties across the Bun test corpus. Construction-style: 1; behavioral (high-cardinality): 1. Total witnessing constraint clauses: 11.
...
**setTimeout** — satisfies the documented invariant. (behavioral; cardinality 9)
