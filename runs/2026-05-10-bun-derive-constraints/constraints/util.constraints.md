...
@provides: util-surface-property
  threshold: UTIL1
  interface: [util.TextDecoder, util.TextEncoder, util.inherits]

@imports: []

@pins: []

Surface drawn from 8 candidate properties across the Bun test corpus. Construction-style: 3; behavioral (high-cardinality): 5. Total witnessing constraint clauses: 594.
...
**util.inspect** — satisfies the documented invariant. (behavioral; cardinality 40)
