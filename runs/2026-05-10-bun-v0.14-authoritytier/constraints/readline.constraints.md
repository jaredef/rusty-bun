...
@provides: readline-surface-property
  threshold: READ1
  interface: [readline.cursorTo, readline.clearLine, readline.createInterface, readline.moveCursor, readline.clearScreenDown]

@imports: []

@pins: []

Surface drawn from 5 candidate properties across the Bun test corpus. Construction-style: 5; behavioral (high-cardinality): 0. Total witnessing constraint clauses: 37.
