...
- **STILL OPEN**: ECDSA / ECDH surfaces — need finite-field-curve primitives (P-256/P-384/P-521 — substantial separate work, ~1500 LOC of curve arithmetic over Weierstrass curves). RSA/ECDSA/ECDH need big-integer + finite-field-curve primitives. AES-KW/CBC/CTR are easy follow-ons to the existing AES block cipher. HKDF is straightforward given the HMAC family.
