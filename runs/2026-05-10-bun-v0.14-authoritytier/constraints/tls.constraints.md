...
@provides: tls-surface-property
  threshold: TLS1
  interface: [tls.createSecureContext, tls.TLSSocket, tls.TLSSocket, tls.checkServerIdentity, tls.connect, tls.connect, tls.connect, tls.rootCertificates, tls.rootCertificates, tls.rootCertificates]

@imports: []

@pins: []

Surface drawn from 10 candidate properties across the Bun test corpus. Construction-style: 10; behavioral (high-cardinality): 0. Total witnessing constraint clauses: 11.
