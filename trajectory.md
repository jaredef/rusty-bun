...
- **`N_persist` = 0** (reset this round per the rule: Phase-2-extension wired `process` global, a major boundary that was silently bypassed by all prior fixtures' dual-path).
