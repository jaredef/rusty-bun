...
**J.1 — Application basket.** Curate a representative basket of Bun-using applications: Hono / Elysia frameworks at example-app level; npm packages whose test suites Bun runs cleanly; Cloudflare Workers examples; small but real-world apps. PARTIAL 2026-05-10: first fixture landed at `host/tests/fixtures/consumer-todo-api/` (Bun.serve-based todo API, ESM + bare-specifier import through in-tree node_modules; 10 self-test cases all pass on rusty-bun-host).
