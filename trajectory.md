...
- **`N_persist` = 0** (held — this round was M9.bis tightening + fixture migration; no new persistence increment because the round was apparatus-discipline work rather than basket-expansion).
