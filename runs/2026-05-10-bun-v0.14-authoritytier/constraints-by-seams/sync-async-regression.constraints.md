...
@provides: sync-async-regression-surface-property
  threshold: SYNC1
  interface: [process.stdout, tty.WriteStream]

@imports: []

@pins: []

Surface drawn from 3 candidate properties across the Bun test corpus. Construction-style: 2; behavioral (high-cardinality): 1. Total witnessing constraint clauses: 268.
