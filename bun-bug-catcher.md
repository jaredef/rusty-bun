...
- **STILL OPEN**: RSA / ECDSA / AES key-wrap surfaces (asymmetric and symmetric block-cipher crypto). These require asymmetric-key crypto pilots and AES round-function implementations not yet in the apparatus — substantial work, likely a separate engagement.
