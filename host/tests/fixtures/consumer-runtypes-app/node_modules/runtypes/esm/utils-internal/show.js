import enumerableKeysOf from "./enumerableKeysOf.js";
import Optional from "../Optional.js";
import Runtype from "../Runtype.js";
import quoteWithBacktick from "./quoteWithBacktick.js";
        ...
        switch (runtype.tag) {
            ...
            case "template": {
                if (runtype.strings.length === 0)
                    ...
                    return quoteWithDoubleQuote(runtype.strings[0]);
...
export default show(false, new Set());
