...
@provides: platform-cfg-async-regression-surface-property
  threshold: PLAT1
  interface: [Bun.spawn, Bun.RedisClient]

@imports: []

@pins: []

Surface drawn from 3 candidate properties across the Bun test corpus. Construction-style: 2; behavioral (high-cardinality): 1. Total witnessing constraint clauses: 219.
