...
@provides: fs-surface-property
  threshold: FS1
  interface: [fs.existsSync, fs.globSync, fs.promises.glob, fs.access, fs.promises.statfs, fs.ReadStream, fs.WriteStream, fs.glob, fs.lstatSync, fs.mkdirSync, fs.promises.glob, fs.promises.mkdir]

@imports: []

@pins: []

Surface drawn from 20 candidate properties across the Bun test corpus. Construction-style: 12; behavioral (high-cardinality): 8. Total witnessing constraint clauses: 255.
