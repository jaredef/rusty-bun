...
@provides: path-surface-property
  threshold: PATH1
  interface: [path.posix.isAbsolute, path]

@imports: []

@pins: []

Surface drawn from 21 candidate properties across the Bun test corpus. Construction-style: 2; behavioral (high-cardinality): 19. Total witnessing constraint clauses: 375.
...
**path.win32.isAbsolute** — produces values matching the documented patterns under the documented inputs. (behavioral; cardinality 22)
...
**path.toNamespacedPath** — produces values matching the documented patterns under the documented inputs. (behavioral; cardinality 12)
...
**path.parse** — produces values matching the documented patterns under the documented inputs. (behavioral; cardinality 9)
...
**path.posix.toNamespacedPath** — produces values matching the documented patterns under the documented inputs. (behavioral; cardinality 7)
