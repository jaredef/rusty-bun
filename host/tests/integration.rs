...
consumer_test!(consumer_node_fetch_app_byte_identical_to_bun, "consumer-node-fetch-app");
...
consumer_test!(consumer_fflate_app_byte_identical_to_bun, "consumer-fflate-app");
consumer_test!(consumer_lodash_merge_app_byte_identical_to_bun, "consumer-lodash-merge-app");
consumer_test!(consumer_lodash_clonedeep_app_byte_identical_to_bun, "consumer-lodash-clonedeep-app");
consumer_test!(consumer_lodash_debounce_app_byte_identical_to_bun, "consumer-lodash-debounce-app");
consumer_test!(consumer_lodash_get_app_byte_identical_to_bun, "consumer-lodash-get-app");
