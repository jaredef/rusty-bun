...
@provides: queuemicrotask-surface-property
  threshold: QUEU1
  interface: [queueMicrotask, queueMicrotask]

@imports: []

@pins: []

Surface drawn from 3 candidate properties across the Bun test corpus. Construction-style: 2; behavioral (high-cardinality): 1. Total witnessing constraint clauses: 7.
