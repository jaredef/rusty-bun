...
const Function = Runtype_js_1.default.create(({ received, expected }) => typeof received === "function"
    ? (0, SUCCESS_js_1.default)(received)
    : FAILURE_js_1.default.TYPE_INCORRECT({ expected, received }), { tag: "function" });
